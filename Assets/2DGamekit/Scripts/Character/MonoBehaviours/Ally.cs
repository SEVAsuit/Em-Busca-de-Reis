...
public class Ally : MonoBehaviour
{
	...
	protected float randomDecision = 0;
	protected bool doOnceDecision = true;
	protected bool endDecision = false;
	...
	public void ApplyDamage(Damager damager, Damageable damageable)
	{
		if (!isInvincible)
		{
			float direction = damager.damage / Mathf.Abs(damager.damage);
	...
	public void MeleeAttack()
	{
		...
		for (int i = 0; i < collidersEnemies.Length; i++)
		{
			...
			{
				Damageable damageable = collidersEnemies[i].gameObject.GetComponent<Damageable>();
				damageable.TakeDamageMetroidvaniaController(this);
			}
		}
	...
	protected IEnumerator NextDecision(float time)
	{
